...
const setImportedByProperty = (fileArray: string[]): object =>
...
const createFlatFileList = (topLevelDirectory: string) =>
  flattenArrayDeep(createFileSummaryList(topLevelDirectory));
